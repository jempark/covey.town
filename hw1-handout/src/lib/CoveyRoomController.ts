...
export default class CoveyRoomController {
  ...
  /** coveyRoomID used so that each room controller knows the name of the room it is mapped to * */
  private readonly _coveyRoomID: string;

  /** public constructor for the coveyRoomID * */
  public constructor(coveyRoomID: string) {
    this._coveyRoomID = coveyRoomID;
  }

  /** Retrieves the coveyRoomID */
